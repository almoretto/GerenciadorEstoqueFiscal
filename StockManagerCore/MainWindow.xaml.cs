...
namespace StockManagerCore
{
    ...
    public partial class MainWindow : Window
    {
            ...
            CompanyService companyService, StockService stockService)
        {
            ...
            tbiFunctions.Visibility = Visibility.Hidden;
            tbiDataView.Visibility = Visibility.Hidden;
            InitializeComponent();
        ...
        {
            ClearForm();
            tbiFunctions.IsSelected = true;
            tbiFunctions.Visibility = Visibility.Visible;
        }
        ...
        private void GenerateGrid(List<DispStockCompany> gridContent, Company c)
        {
            ...
            tbiDataView.Visibility = Visibility.Visible;
            InitializeComponent();
        }
